...
### Директории проекта {#directories}
...
### Пользовательские настройки {#load-bootstrap}
...
### Настройка текущего языка (I18n) {#i18n}
...
### Проверка степени готовности {#environment}
...
### Дефолтные драйверы конфигов и логов {#logs-configs}
