...
### Расположение директорий проекта
...
### Загрузка пользовательских настроек для приложения
...
### Настройка текущего языка приложения (I18n)
...
### Добавление дефолтных драйверов конфигов и логов
...
### Что еще можно здесь разместить?
...
## Файлы MODPATH/<modules>/init.php
